...
-   The US Census and OSM services are free while Geocodio, Location IQ, OpenCage, Mapbox, HERE and TomTom are commercial services that offer both free and paid usage tiers. The Google service [bills per query](https://developers.google.com/maps/documentation/geocoding/usage-and-billing).
