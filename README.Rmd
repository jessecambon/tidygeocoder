...
Tidygeocoder makes getting data from geocoding services easy. Currently supported services include the [US Census](https://geocoding.geo.census.gov/), [Nominatim (OSM)](https://nominatim.org), [Geocodio](https://www.geocod.io/), and [Location IQ](https://locationiq.com/). You can find a demo I wrote up on using this package to plot landmarks in Washington, DC [here](https://jessecambon.github.io/2019/11/11/tidygeocoder-demo.html).
...
In this brief example, we will use the US Census API to geocode a few select addresses in the `sample_addresses` dataset.
...
Now that we have the latitude and longitude, we can plot our addresses with ggplot:
...
For further documentation, refer to the [Getting Started page](https://jessecambon.github.io/tidygeocoder/articles/tidygeocoder.html) and the [function references](https://jessecambon.github.io/tidygeocoder/reference/index.html).
