...
globe_background <- ggplot()  +
  geom_sf(data = sphere, color = 'black', size = 0.15) +
  geom_sf(data = world_coastlines, color = "black", size = 0.05) +
  coord_sf(crs = st_crs(3035)) +
...
s <- sticker(globe_background,
    package = "tidygeocoder", p_size = 6, s_x = 1, s_y = .75, s_width = 1, s_height = 1, p_family = "Noto Serif",
