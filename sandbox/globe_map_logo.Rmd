...
globe_background <- ggplot()  +
  geom_sf(data = sphere, color = 'black', size = 0.06, fill = 'white') +
  geom_sf(data = world_coastlines, color = "black", size = 0.03) +
...
s <- sticker(globe_background,
    package = "tidygeocoder", p_size = 18, s_x = 1, s_y = .75, s_width = 1, s_height = 1, p_family = "Noto Serif",
