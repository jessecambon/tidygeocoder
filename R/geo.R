...
#' @param param_error `r lifecycle::badge("deprecated")` if TRUE then an error will be thrown if 
#'   any address parameters are used that are invalid for the selected service (`method`). 
