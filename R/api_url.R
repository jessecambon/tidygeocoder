...
get_api_url <- function(method,
                        ...
                        geocodio_v = pkg.globals$default_api_options$geocodio_v,
                        iq_region = pkg.globals$default_api_options$iq_region,
                        mapbox_permanent = pkg.globals$default_api_options$mapbox_permanent,
                        mapquest_open = pkg.globals$default_api_options$mapquest_open,
  ...
  api_url <- switch(method,
    ...
    "mapbox" = get_mapbox_url(mapbox_permanent),
