...
The supported geocoder services are shown in the table below. The `method` is used to select the geocoder service in tidygeocoder functions such as `geo()` and `reverse_geo()`. Refer to each service's API documentation for more details.
