...
## Dataset for testing
## note the version=2 option in save(), this is to prevent a R3.5 >= dependency
## being included with this package
...
#                            )
# save(sample_addresses,file='../data/sample_addresses.rda',version=2)
```
...
Note that international and non-street addresses were not found since we are using the Census geocoder service. 
