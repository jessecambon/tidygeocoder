...
# (ie. we have an internet connection)

# Check that US Census service is available
tryCatch(
      expr = {
        tidygeocoder::geo('1600 Pennsylvania Avenue NW, Washington, DC 20500', 
                          method = 'census')
      },
      error = function(e) {
...
tryCatch(
      expr = {
        tidygeocoder::geo('London', method = 'osm')
        tidygeocoder::reverse_geo(lat = 0, long = 0, method = 'osm')
      },
      error = function(e) {
