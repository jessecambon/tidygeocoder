...
<!-- 
############################ INSTRUCTIONS ###########################################
# 1. Make all changes to tidygeocoder.Rmd.orig 
...
|:-----------------------------------------|--------:|---------:|
|11 Wall St, NY, NY                        | 43.00929| -78.87870|
...
#> $ address        <chr> "Freedom Plaza, 1455, Pennsylvania Avenue Northwest, Washington, District of Columbia, 200…
#> $ place_id       <int> 284009208, 148364261
#> $ licence        <chr> "Data © OpenStreetMap contributors, ODbL 1.0. https://osm.org/copyright", "Data © OpenStre…
...
#> $ boundingbox    <list> <"38.8956276", "38.896068", "-77.03182", "-77.0297273">, <"43.6529946", "43.6541458", "-79…
...
#> $ lat          <dbl> -12.06211, -12.20011, -11.99997, 30.04439, 30.03521, 30.08695
#> $ long         <dbl> -77.03653, -76.28506, -76.83322, 31.23573, 31.56337, 31.96162
#> $ place_id     <int> 49009999, 282617684, 282722041, 728384, 283020077, 216381765
#> $ licence      <chr> "Data © OpenStreetMap contributors, ODbL 1.0. https://osm.org/copyright", "Data © OpenStreet…
#> $ osm_type     <chr> "node", "relation", "relation", "node", "relation", "way"
#> $ osm_id       <dbl> 4289361265, 1944659, 1944670, 271613766, 5466227, 544272017
#> $ boundingbox  <list> <"-12.2221065", "-11.9021065", "-77.1965256", "-76.8765256">, <"-13.3241714", "-10.2741856",…
#> $ display_name <chr> "Lima, Lima Metropolitana, Lima, LIMA 15046, Perú", "Lima, Perú", "Lima, Lima Metropolitana,…
#> $ class        <chr> "place", "boundary", "boundary", "place", "place", "highway"
#> $ type         <chr> "city", "administrative", "administrative", "city", "city", "motorway"
#> $ importance   <dbl> 0.7830015, 0.6119761, 0.5934835, 0.6960286, 0.6960286, 0.1000000
#> $ icon         <chr> "https://nominatim.openstreetmap.org/ui/mapicons//poi_place_city.p.20.png", "https://nominat…
```
...
#> $ display_name        <chr> "القاهرة, محافظة القاهرة, 11519, مصر"
#> $ class               <chr> "place"
#> $ type                <chr> "city"
