...
This page contains documentation for those wishing to contribute to the package and instructions on how to add support for a new geocoder service.
...
- Because the specified geocoder service has a usage limit, the rate of querying is limited accordingly. This behaviour can be modified with the `min_time` argument.
...
Refer to the notes below on adding a geocoder service for documentation on the code structure.
