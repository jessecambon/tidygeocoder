...
- Run the pre-computed [vignette](https://github.com/jessecambon/tidygeocoder/blob/main/vignettes/tidygeocoder.Rmd.orig) to update the output. Inspect the vignette output for any problems (ie. are there missing results?). It can be helpful to build the site and view the HTML output for this.
...
Last, run `devtools::release()` to release the new version.