---
title: "Adding a Geocode Service"
output: rmarkdown::html_vignette
description: >
  Refer to this page on how to add support for a geocoder service to the package.
vignette: >
  %\VignetteIndexEntry{Adding a Geocode Service}
  %\VignetteEngine{knitr::rmarkdown}
  \usepackage[utf8]{inputenc}
---

This page documents how to add support for a new geocoder service to the package. Required changes are organized by file. If anything isn't clear, feel free to f[ile an issue](https://github.com/jessecambon/tidygeocoder/issues).
...
* **[R/reverse_geo.R](https://github.com/jessecambon/tidygeocoder/blob/master/R/reverse_geo.R)**
    ...
    * Add the new method to the `reverse_geo()` documentation.
...
These files won't need editing unless the service you are implementing requires a workaround.
